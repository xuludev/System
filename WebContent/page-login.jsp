...
<%@page import="com.xulu.main.DBConnect"%>
...
<script type="text/javascript">
	function isEmail() {
		reg = /^\w{3,}@\w+(\.\w+)+$/;
		if (!reg.test($('#login-username').val())) {
			$('#login-username').css('background-color', '#FF7373');
		} else {
	...
	function passForm() {
		var passLen = $('#login-password').val().length;
		if (passLen < 6) {
			$('#login-password').css('background-color', '#FF7373');
		} else {
		...
		<div class="container">
			<div class="menuextras">
				<div class="extras">
					<ul>
						<li>
							<div class="dropdown choose-country"></div>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-5">
					<div class="basic-login">
						<form role="form" method="post" action="servlet/LoginServlet">
							<div class="form-group">
								<label for="login-username"><i class="icon-user"></i> <b>邮
										箱</b> </label> <input class="form-control" id="login-username"
									type="email" placeholder="" onchange="isEmail()" name="email" />
							</div>
							<div class="form-group">
								<label for="login-password"><i class="icon-lock"></i> <b>密
										码</b> </label> <input class="form-control" id="login-password"
									type="password" placeholder="" onchange="passForm()"
									name="password" />
							</div>
							<div class="form-group">
								<label class="checkbox"> 
								</label> <a href="page-password-reset.html" class="forgot-password">忘记密码?</a>
				...
				<div class="col-sm-7 social-login"></div>
				<div class="clearfix"></div>
				<div class="not-member">
					<p>
						&nbsp;&nbsp;&nbsp;&nbsp;还没有账号？&nbsp;&nbsp; <a
							href="page-register.html">点此注册</a>
					</p>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-footer col-md-4 col-xs-6">
					...
					<p class="contact-us-details">
						<b>Address:</b>武汉市洪山区, 李纸路徐家墩,湖北工业大学, 经济与管理学院, 11信管, 徐璐 <br />
						<br /> <b>知乎:</b> <a href="https://www.zhihu.com/people/xulu-0620/activities">LucasX</a> <br /> <b>Github:</b> <a href="https://github.com/EclipseXuLu">LucasX</a> <br /> <b>Email:</b>
						<a href="mailto:249048056@qq.com">xulu0620@qq.com</a>
					</p>
				</div>
